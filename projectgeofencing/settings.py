"""
Django settings for projectgeofencing project.
...
SECRET_KEY = 'django-insecure-m4hzhh-w*q_fxb0)6-+3&@if(&2^hhzof_#aea_rg*k($gnh9%'
...
ROOT_URLCONF = 'projectgeofencing.urls'
...
WSGI_APPLICATION = 'projectgeofencing.wsgi.application'
